...
def _load_img_as_tensor(img_path, image_size):
    ...
    img = torch.from_numpy(img_np).permute(2, 0, 1) # transpose to [3, 1024, 1024]
...
def load_video_frames_by_np_data(
    ...
    for n in range(num_frames):
        ...
        img_resized = torch.nn.functional.interpolate(img_tensor, size=(image_size, image_size), mode='bilinear', align_corners=False)
